...
const RAW_OPPORTUNITIES = [
  // 1. BFSI / RegTech
  {
    ...
    signalsTimeline: TIMELINE(45, 52, 68, 74, 85, 91),
    hiringSignals: [
      { role: 'Head of RegTech Compliance', volume: 'High', salaryRange: '₹35L - ₹50L p.a.', count: 42 },
      { role: 'Lending Compliance Analyst', volume: 'High', salaryRange: '₹12L - ₹20L p.a.', count: 110 },
      { role: 'AI Integration Specialist (FinTech)', volume: 'Medium', salaryRange: '₹22L - ₹32L p.a.', count: 35 },
    ],
    skillSignals: [
      { skill: 'RBI Fair Practice Code Auditing', scarcity: 'Critical', impact: 'Lets the system flag collection-agency behaviour patterns against exact clauses.' },
      { skill: 'Fine-Tuning Fin-LLMs', scarcity: 'High', impact: 'Processes transcripts containing mixed English and Hindi dialects.' },
      { skill: 'Audio Transcription Analysis', scarcity: 'Medium', impact: 'Required to ingest multi-lingual call-centre recordings.' },
    ],
    regulatorySignals: [
      { regulationName: 'RBI Digital Lending Guidelines (updates)', agency: 'RBI', summary: 'Mandatory logging and disclosure of borrower communications, with strict penalties for outsourced agent misconduct.', date: 'April 2026' },
      { regulationName: 'DPDP Act', agency: 'Government of India', summary: 'Requires clear consent-management logs for marketing outreach and financial disclosures.', date: 'August 2025' },
    ],
    technologySignals: [
      { tech: 'Fine-Tuned Open Source LLMs (Llama-3-70B)', adoptionRate: 'Accelerating', description: 'Fine-tuned on Indian regulatory text for zero-shot clause violation detection.' },
      { tech: 'Indic Speech-to-Text (Whisper Fine-tuned)', adoptionRate: 'Maturing', description: 'Captures mixed Hinglish and regional dialect nuances from customer service calls.' },
    ],
    competitionList: [
      { name: 'Manual Audit Teams', category: 'Incumbent Outsourcers', strength: 'Strong', pricing: 'High per-seat pricing' },
      { name: 'Generic Global Speech Analytics', category: 'Global Enterprise SaaS', strength: 'Weak', pricing: '$150k+ contracts, lacks Indian vernacular understanding' },
    ],
    ...
    risks: ['Strict on-premise deployment requirements for Tier-1 public sector banks.'],
    ...
    relatedOpportunities: ['bfsi-fraud-prevention', 'bfsi-gst-reconciliation'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '15 Aug 2026',
    source: 'seed',
  },

  // 2. BFSI / Payments Fraud
  {
    ...
    vertical: 'BFSI',
    score: 89,
    scores: { demand: 92, hiring: 85, regulation: 89, skills: 86, competition: 72, timing: 91, indiaRelevance: 99 },
    momentum: 'surging',
    changePercentage: 62,
    signalCount: 24,
    sourceCount: 7,
    ...
    signalsTimeline: TIMELINE(50, 58, 65, 78, 88, 95),
    hiringSignals: [
      { role: 'Fraud Risk Data Scientist', volume: 'High', salaryRange: '₹24L - ₹40L p.a.', count: 32 },
      { role: 'Payment Gateway Security Architect', volume: 'Medium', salaryRange: '₹30L - ₹48L p.a.', count: 18 },
    ],
    skillSignals: [
      { skill: 'Graph Neural Networks for Mule Detection', scarcity: 'Critical', impact: 'Traces multi-hop transaction rings in milliseconds.' },
      { skill: 'NPCI UPI API Protocol Specs', scarcity: 'High', impact: 'Direct integration with switch telemetries.' },
    ],
    regulatorySignals: [
      { regulationName: 'NPCI Mule Account Directive', agency: 'NPCI', summary: 'Mandatory real-time screening of rapid inward/outward velocity patterns.', date: 'May 2026' },
    ],
    technologySignals: [
      { tech: 'Graph Neural Networks & Redis Graph', adoptionRate: 'Accelerating', description: 'Sub-50ms graph traversal across millions of VPA endpoints.' },
    ],
    competitionList: [
      { name: 'Legacy Rule Engines', category: 'Banking Software', strength: 'Medium', pricing: 'Annual enterprise licence' },
    ],
    ...
    risks: ['High throughput and sub-50ms latency SLA requirements.'],
    ...
    relatedOpportunities: ['bfsi-ai-compliance', 'bfsi-msme-credit-scoring'],
    feeds: { reddit: [], github: [], linkedin: [] },
  ...
  // 3. BFSI / TaxTech
  {
    ...
    vertical: 'BFSI',
    score: 87,
    scores: { demand: 90, hiring: 81, regulation: 95, skills: 78, competition: 65, timing: 88, indiaRelevance: 100 },
    momentum: 'rising',
    changePercentage: 35,
    signalCount: 19,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(40, 48, 55, 67, 78, 86),
    hiringSignals: [
      { role: 'GST Domain Tech Lead', volume: 'High', salaryRange: '₹20L - ₹32L p.a.', count: 48 },
      { role: 'Tally / ERP API Integration Engineer', volume: 'High', salaryRange: '₹12L - ₹18L p.a.', count: 65 },
    ],
    skillSignals: [
      { skill: 'GSTN GSP API Integration', scarcity: 'High', impact: 'Direct real-time communication with government GST portals.' },
      { skill: 'Tally XML / Zoho Books Integration', scarcity: 'Medium', impact: 'Pulls raw purchase ledgers automatically.' },
    ],
    regulatorySignals: [
      { regulationName: 'CBIC Rule 36(4) Strict ITC Matching', agency: 'CBIC', summary: '100% matching of invoice credits required in GSTR-2B.', date: 'January 2026' },
    ],
    technologySignals: [
      { tech: 'LayoutLM Document OCR', adoptionRate: 'Maturing', description: 'Extracts line-item GSTIN, HSN, and tax splits from unstructured invoice PDFs.' },
    ],
    competitionList: [
      { name: 'Generic Accounting Software', category: 'Desktop ERP', strength: 'Strong', pricing: 'Static license' },
    ],
    ...
    risks: ['Changes in government GST portal schemas and throttling.'],
    indiaRelevanceText: '100% tailored to CBIC filing mandates, GSTR-1/2B/3B workflows, and Indian accounting software ecosystem.',
    relatedOpportunities: ['bfsi-msme-credit-scoring', 'saas-ca-firm-workflow'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '14 Aug 2026',
    source: 'seed',
  },

  // 4. BFSI / MSME Underwriting
  {
    ...
    vertical: 'BFSI',
    score: 85,
    scores: { demand: 88, hiring: 79, regulation: 84, skills: 82, competition: 68, timing: 89, indiaRelevance: 99 },
    momentum: 'rising',
    changePercentage: 37,
    signalCount: 16,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(26, 34, 45, 57, 69, 82),
    hiringSignals: [
      { role: 'Credit Risk Data Scientist', volume: 'High', salaryRange: '₹18L - ₹32L p.a.', count: 38 },
      { role: 'Account Aggregator Integration Engineer', volume: 'Medium', salaryRange: '₹14L - ₹24L p.a.', count: 16 },
    ],
    skillSignals: [
      { skill: 'Cash-Flow Underwriting Modeling', scarcity: 'High', impact: 'Turns transaction streams into a defensible repayment estimate.' },
      { skill: 'Account Aggregator AA Consent Flows', scarcity: 'High', impact: 'Lawfully retrieves real-time bank statement data.' },
    ],
    regulatorySignals: [
      { regulationName: 'Account Aggregator Framework', agency: 'RBI', summary: 'Consent-based financial data sharing between regulated financial entities.', date: 'March 2026' },
    ],
    technologySignals: [
      { tech: 'XGBoost with SHAP Explainability', adoptionRate: 'Stable', description: 'Generates transparent credit scores that risk committees approve.' },
    ],
    competitionList: [
      { name: 'CIBIL / Experian', category: 'Traditional Credit Bureau', strength: 'Strong', pricing: 'Per inquiry' },
    ],
    ...
    risks: ['Account Aggregator consent drop-off during user onboarding.'],
    indiaRelevanceText: 'Built specifically for India’s IndiaStack, Account Aggregator network, and GSTN public rails.',
    relatedOpportunities: ['bfsi-gst-reconciliation', 'bfsi-fraud-prevention'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '12 Aug 2026',
    source: 'seed',
  },

  // 5. IT / DevOps / Migration
  {
    ...
    vertical: 'IT',
    score: 91,
    scores: { demand: 94, hiring: 90, regulation: 65, skills: 92, competition: 62, timing: 95, indiaRelevance: 95 },
    momentum: 'surging',
    changePercentage: 74,
    signalCount: 31,
    sourceCount: 8,
    ...
    signalsTimeline: TIMELINE(35, 48, 62, 75, 89, 97),
    hiringSignals: [
      { role: 'Principal Compiler & AST Engineer', volume: 'High', salaryRange: '₹35L - ₹60L p.a.', count: 28 },
      { role: 'Legacy Modernization Architect', volume: 'High', salaryRange: '₹28L - ₹45L p.a.', count: 54 },
    ],
    skillSignals: [
      { skill: 'AST Parsing & Code Property Graphs', scarcity: 'Critical', impact: 'Guarantees semantic equivalence between old and new code.' },
      { skill: 'Automated Regression Harness Generation', scarcity: 'High', impact: 'Tests edge cases without human intervention.' },
    ],
    regulatorySignals: [],
    technologySignals: [
      { tech: 'Tree-sitter & Semantic Code Graphs', adoptionRate: 'Accelerating', description: 'Enables high-precision structural code understanding.' },
    ],
    competitionList: [
      { name: 'Manual Developer Outsourcing', category: 'IT Services', strength: 'Strong', pricing: 'Time & Material billing' },
    ],
    ...
    risks: ['Edge case divergence in complex proprietary frameworks.'],
    indiaRelevanceText: 'India is the global capital of enterprise IT maintenance and legacy modernization contracts.',
    relatedOpportunities: ['it-llm-observability', 'it-agentic-guardrails'],
    feeds: { reddit: [], github: [], linkedin: [] },
  ...
  // 6. IT / AI Infra
  {
    ...
    vertical: 'IT',
    score: 88,
    scores: { demand: 91, hiring: 84, regulation: 72, skills: 88, competition: 70, timing: 94, indiaRelevance: 82 },
    momentum: 'surging',
    changePercentage: 58,
    signalCount: 22,
    sourceCount: 6,
    ...
    signalsTimeline: TIMELINE(28, 42, 58, 70, 84, 92),
    hiringSignals: [
      { role: 'AI Platform / MLOps Engineer', volume: 'High', salaryRange: '₹20L - ₹38L p.a.', count: 45 },
      { role: 'Distributed Systems Rust Engineer', volume: 'Medium', salaryRange: '₹25L - ₹42L p.a.', count: 20 },
    ],
    skillSignals: [
      { skill: 'Vector Semantic Caching (Qdrant/Milvus)', scarcity: 'High', impact: 'Determines if a new prompt matches a cached response.' },
      { skill: 'High-Performance Reverse Proxy Engineering', scarcity: 'High', impact: 'Maintains sub-10ms proxy overhead.' },
    ],
    regulatorySignals: [
      { regulationName: 'EU AI Act & DPDP Compliance', agency: 'Regulatory Authorities', summary: 'Requires logging and explainability of automated AI agent decisions.', date: 'July 2026' },
    ],
    technologySignals: [
      { tech: 'Rust / Envoy Proxy Extensions', adoptionRate: 'Accelerating', description: 'Enables ultra-low latency prompt inspection.' },
    ],
    competitionList: [
      { name: 'Direct Provider SDKs', category: 'Provider Default', strength: 'Strong', pricing: 'Raw token cost' },
    ],
    ...
    risks: ['Cloud providers adding native caching at the model endpoint layer.'],
    ...
    relatedOpportunities: ['it-agentic-guardrails', 'it-code-migration'],
    feeds: { reddit: [], github: [], linkedin: [] },
  ...
  // 7. IT / AI Security
  {
    ...
    vertical: 'IT',
    score: 83,
    scores: { demand: 85, hiring: 80, regulation: 76, skills: 90, competition: 65, timing: 92, indiaRelevance: 78 },
    momentum: 'rising',
    changePercentage: 51,
    signalCount: 15,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(15, 25, 40, 55, 70, 85),
    hiringSignals: [
      { role: 'AI Security Researcher', volume: 'Medium', salaryRange: '₹28L - ₹45L p.a.', count: 18 },
    ],
    skillSignals: [
      { skill: 'MCP (Model Context Protocol) Security', scarcity: 'Critical', impact: 'Validates tool schemas and prevents privilege escalation.' },
    ],
    regulatorySignals: [],
    technologySignals: [
      { tech: 'Wasm Sandboxing for Agent Tools', adoptionRate: 'Emerging', description: 'Executes untrusted agent-generated code in isolated micro-runtimes.' },
    ],
    competitionList: [
      { name: 'Traditional WAFs', category: 'Web Security', strength: 'Weak', pricing: 'Enterprise contract' },
    ],
    ...
    risks: ['Agent runtime standards are rapidly evolving.'],
    ...
    relatedOpportunities: ['it-llm-observability', 'it-code-migration'],
    feeds: { reddit: [], github: [], linkedin: [] },
  ...
  // 8. HealthTech / ABDM
  {
    ...
    vertical: 'HEALTHCARE',
    score: 90,
    scores: { demand: 89, hiring: 82, regulation: 98, skills: 85, competition: 60, timing: 95, indiaRelevance: 100 },
    momentum: 'surging',
    changePercentage: 68,
    signalCount: 20,
    sourceCount: 6,
    ...
    signalsTimeline: TIMELINE(30, 42, 58, 72, 85, 94),
    hiringSignals: [
      { role: 'FHIR / ABDM Integration Specialist', volume: 'High', salaryRange: '₹15L - ₹26L p.a.', count: 36 },
      { role: 'Healthcare Product Manager', volume: 'Medium', salaryRange: '₹22L - ₹35L p.a.', count: 18 },
    ],
    skillSignals: [
      { skill: 'HL7 / FHIR Standard Formatting', scarcity: 'High', impact: 'Structures clinical data into standardized Indian health records.' },
      { skill: 'NHA ABDM Sandbox API Certification', scarcity: 'Critical', impact: 'Direct compliance validation with government health servers.' },
    ],
    regulatorySignals: [
      { regulationName: 'ABDM Unified Health Interface (UHI)', agency: 'National Health Authority', summary: 'Mandates interoperable digital health records for insurance claims.', date: 'May 2026' },
    ],
    technologySignals: [
      { tech: 'Voice-to-FHIR Clinical NLP', adoptionRate: 'Accelerating', description: 'Transcribes doctor voice notes into structured ICD-10 diagnostic codes.' },
    ],
    competitionList: [
      { name: 'Legacy Hospital Desktop Software', category: 'On-premise ERP', strength: 'Medium', pricing: 'Large upfront license' },
    ],
    ...
    risks: ['Slow doctor adoption of typing-heavy software in high-volume OPDs.'],
    indiaRelevanceText: '100% built around the Ayushman Bharat Digital Mission (ABDM), ABHA IDs, and NHA infrastructure.',
    relatedOpportunities: ['health-diagnostic-teleradiology', 'bfsi-ai-compliance'],
    feeds: { reddit: [], github: [], linkedin: [] },
  ...
  // 9. AgriTech / e-NAM
  {
    ...
    vertical: 'AGRITECH',
    score: 86,
    scores: { demand: 87, hiring: 76, regulation: 90, skills: 80, competition: 64, timing: 88, indiaRelevance: 100 },
    momentum: 'rising',
    changePercentage: 42,
    signalCount: 14,
    sourceCount: 4,
    ...
    signalsTimeline: TIMELINE(25, 36, 48, 62, 75, 84),
    hiringSignals: [
      { role: 'Agri-Fintech Credit Underwriter', volume: 'Medium', salaryRange: '₹14L - ₹24L p.a.', count: 22 },
      { role: 'IoT Commodity Quality Engineer', volume: 'Medium', salaryRange: '₹12L - ₹20L p.a.', count: 15 },
    ],
    skillSignals: [
      { skill: 'WDRA e-NWR Integration', scarcity: 'High', impact: 'Enables banks to hold digital lien on stored grain.' },
    ],
    regulatorySignals: [
      { regulationName: 'WDRA Electronic Warehouse Receipts', agency: 'WDRA / NABARD', summary: 'Zero-stamp-duty digital warehouse receipt pledge framework.', date: 'June 2026' },
    ],
    technologySignals: [
      { tech: 'Spectroscopy & Smartphone Grain Quality AI', adoptionRate: 'Emerging', description: 'Assesses moisture and grain purity from a phone camera snapshot.' },
    ],
    competitionList: [
      { name: 'Traditional Mandi Commission Agents', category: 'Informal Credit', strength: 'Strong', pricing: 'High informal interest rates (24-36%)' },
    ],
    ...
    risks: ['Rural internet connectivity and seasonal crop yield volatility.'],
    indiaRelevanceText: 'Directly leverages NABARD subsidies, e-NAM integration, and Indian agricultural mandi supply chains.',
    relatedOpportunities: ['agri-perishable-coldchain', 'bfsi-msme-credit-scoring'],
    feeds: { reddit: [], github: [], linkedin: [] },
  ...
  // 10. Logistics / ONDC
  {
    ...
    vertical: 'LOGISTICS',
    score: 88,
    scores: { demand: 90, hiring: 83, regulation: 92, skills: 84, competition: 66, timing: 96, indiaRelevance: 100 },
    momentum: 'surging',
    changePercentage: 64,
    signalCount: 21,
    sourceCount: 6,
    ...
    signalsTimeline: TIMELINE(32, 45, 60, 74, 88, 96),
    hiringSignals: [
      { role: 'Beckn Protocol Engineer', volume: 'High', salaryRange: '₹18L - ₹30L p.a.', count: 28 },
      { role: 'Hyperlocal Logistics Operations Manager', volume: 'High', salaryRange: '₹12L - ₹20L p.a.', count: 42 },
    ],
    skillSignals: [
      { skill: 'Beckn Protocol v2 Specifications', scarcity: 'Critical', impact: 'Handles decentralized search, select, init, confirm loops.' },
      { skill: 'Dynamic Fleet Routing Optimization', scarcity: 'High', impact: 'Matches order dimensions with optimal rider proximity.' },
    ],
    regulatorySignals: [
      { regulationName: 'DPIIT ONDC Expansion Mandate', agency: 'Ministry of Commerce & Industry', summary: 'Targeting 25% of India e-commerce market share on open protocol.', date: 'April 2026' },
    ],
    technologySignals: [
      { tech: 'Decentralized Beckn Protocol Over WebSocket', adoptionRate: 'Accelerating', description: 'Real-time peer-to-peer commerce broadcast network.' },
    ],
    competitionList: [
      { name: 'Walled Garden E-commerce Platforms', category: 'Marketplace Duopoly', strength: 'Strong', pricing: 'High 25-40% take rates' },
    ],
    ...
    risks: ['Rapid protocol version iterations and rider non-compliance during monsoon seasons.'],
    indiaRelevanceText: 'Built exclusively for India’s Open Network for Digital Commerce (ONDC) and DPIIT open-rail ecosystem.',
    relatedOpportunities: ['retail-quickcommerce-inventory', 'logistics-ev-fleet-bms'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '18 Aug 2026',
    source: 'seed',
  },

  // 11. LegalTech / e-Courts
  {
    ...
    vertical: 'LEGALTECH',
    score: 87,
    scores: { demand: 88, hiring: 80, regulation: 86, skills: 89, competition: 62, timing: 91, indiaRelevance: 100 },
    momentum: 'rising',
    changePercentage: 45,
    signalCount: 16,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(28, 38, 50, 64, 76, 88),
    hiringSignals: [
      { role: 'Legal Tech Prompt Engineer (LL.B Required)', volume: 'Medium', salaryRange: '₹14L - ₹25L p.a.', count: 18 },
      { role: 'Search & Vector Indexing Engineer', volume: 'Medium', salaryRange: '₹20L - ₹34L p.a.', count: 14 },
    ],
    skillSignals: [
      { skill: 'Indian Penal Code & Bharatiya Nyaya Sanhita (BNS) Mapping', scarcity: 'High', impact: 'Bridges old IPC citations with newly enacted BNS criminal codes.' },
      { skill: 'Hierarchical Legal Vector Retrieval', scarcity: 'High', impact: 'Preserves judgment ratio decidendi vs obiter dicta distinctions.' },
    ],
    regulatorySignals: [
      { regulationName: 'e-Courts Mission Mode Phase III', agency: 'Supreme Court of India', summary: 'AI and cloud-enabled digital courtroom infrastructure initiative.', date: 'February 2026' },
      { regulationName: 'Bharatiya Nyaya Sanhita Transition', agency: 'Ministry of Home Affairs', summary: 'Complete replacement of Indian criminal statutes requiring cross-code indexing.', date: 'July 2024' },
    ],
    technologySignals: [
      { tech: 'Hybrid Dense-Sparse (BM25 + ColBERT) Retrieval', adoptionRate: 'Maturing', description: 'Guarantees exact section number matches alongside semantic case summaries.' },
    ],
    competitionList: [
      { name: 'Legacy Legal Search Portals', category: 'Keyword Database', strength: 'Strong', pricing: 'High annual subscription (₹40,000/yr)' },
    ],
    ...
    risks: ['Hallucination risk in citation numbers requires strict verified guardrails.'],
    indiaRelevanceText: '100% focused on Indian jurisprudence, Bharatiya Nyaya Sanhita (BNS), and High Court case law taxonomy.',
    relatedOpportunities: ['bfsi-ai-compliance', 'saas-ca-firm-workflow'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '17 Aug 2026',
    source: 'seed',
  },
  ...
  // 12. SaaS / CA Workflow
  {
    ...
    vertical: 'SAAS',
    score: 89,
    scores: { demand: 93, hiring: 81, regulation: 94, skills: 82, competition: 68, timing: 92, indiaRelevance: 100 },
    momentum: 'surging',
    changePercentage: 55,
    signalCount: 23,
    sourceCount: 6,
    ...
    signalsTimeline: TIMELINE(38, 48, 62, 75, 87, 95),
    hiringSignals: [
      { role: 'Fintech Automation Engineer', volume: 'High', salaryRange: '₹14L - ₹22L p.a.', count: 34 },
    ],
    skillSignals: [
      { skill: 'Income Tax AIS / 26AS JSON Parsing', scarcity: 'High', impact: 'Direct reconciliation with tax department statements.' },
    ],
    regulatorySignals: [
      { regulationName: 'CBDT Annual Information Statement (AIS)', agency: 'Income Tax Department', summary: 'Comprehensive tracking of all financial transactions requiring pre-filing reconciliation.', date: 'May 2026' },
    ],
    technologySignals: [
      { tech: 'Multi-Bank Statement Parser Engine', adoptionRate: 'Stable', description: 'Decodes password-protected PDF statements from all 40+ Indian banks.' },
    ],
    competitionList: [
      { name: 'Manual Excel Worksheets', category: 'Status Quo', strength: 'Strong', pricing: 'Free manual labor' },
    ],
    ...
    risks: ['Strict data privacy and encryption requirements for sensitive client tax records.'],
    ...
    relatedOpportunities: ['bfsi-gst-reconciliation', 'legal-ecourts-litigation-rag'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '20 Aug 2026',
    source: 'seed',
  },

  // 13. Logistics / CleanTech (EV Fleet)
  {
    ...
    vertical: 'CLEANTECH',
    score: 86,
    scores: { demand: 88, hiring: 85, regulation: 88, skills: 89, competition: 64, timing: 93, indiaRelevance: 97 },
    momentum: 'rising',
    changePercentage: 47,
    signalCount: 17,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(24, 35, 48, 62, 76, 88),
    hiringSignals: [
      { role: 'Battery Management System (BMS) Firmware Engineer', volume: 'High', salaryRange: '₹18L - ₹32L p.a.', count: 28 },
      { role: 'IoT Edge Telematics Architect', volume: 'Medium', salaryRange: '₹22L - ₹36L p.a.', count: 16 },
    ],
    skillSignals: [
      { skill: 'CAN Bus Protocol & BMS Telemetry', scarcity: 'Critical', impact: 'Pulls voltage, current, and cell temperature in real-time.' },
      { skill: 'Lithium Iron Phosphate (LFP) Degradation Modeling', scarcity: 'High', impact: 'Predicts remaining useful life under Indian climate cycles.' },
    ],
    regulatorySignals: [
      { regulationName: 'AIS-156 / AIS-038 EV Safety Standards', agency: 'Ministry of Road Transport & Highways', summary: 'Mandatory thermal propagation alerts and BMS safety telemetry.', date: 'April 2026' },
    ],
    technologySignals: [
      { tech: 'CAN-Bus IoT Dongles with MQTT Streaming', adoptionRate: 'Accelerating', description: 'Streams cell-level telemetry directly to cloud time-series databases.' },
    ],
    competitionList: [
      { name: 'OEM Proprietary Apps', category: 'Closed Hardware', strength: 'Medium', pricing: 'Bundled with vehicle' },
    ],
    ...
    risks: ['OEMs locking CAN-bus telemetry ports.'],
    ...
    relatedOpportunities: ['logistics-ondc-dispatch', 'retail-quickcommerce-inventory'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '19 Aug 2026',
    source: 'seed',
  },

  // 14. Retail / QuickCommerce
  {
    ...
    vertical: 'SAAS',
    score: 87,
    scores: { demand: 90, hiring: 82, regulation: 60, skills: 86, competition: 68, timing: 95, indiaRelevance: 96 },
    momentum: 'surging',
    changePercentage: 60,
    signalCount: 19,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(25, 38, 52, 68, 80, 92),
    hiringSignals: [
      { role: 'Quick Commerce Supply Chain Lead', volume: 'High', salaryRange: '₹22L - ₹38L p.a.', count: 35 },
    ],
    skillSignals: [
      { skill: 'Hyperlocal Time-Series Spatio-Temporal Forecasting', scarcity: 'High', impact: 'Predicts pin-code level surge buying patterns.' },
    ],
    regulatorySignals: [],
    technologySignals: [
      { tech: 'Temporal Graph Networks', adoptionRate: 'Emerging', description: 'Models cross-category basket affinity under weather triggers.' },
    ],
    competitionList: [
      { name: 'Generic ERP Inventory Modules', category: 'Traditional Supply Chain', strength: 'Weak', pricing: 'Annual enterprise license' },
    ],
    ...
    risks: ['Dark store platform API access restrictions.'],
    ...
    relatedOpportunities: ['logistics-ondc-dispatch', 'logistics-ev-fleet-bms'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '18 Aug 2026',
    source: 'seed',
  },

  // 15. HRTech / Blue Collar
  {
    ...
    vertical: 'SAAS',
    score: 86,
    scores: { demand: 89, hiring: 78, regulation: 95, skills: 79, competition: 65, timing: 89, indiaRelevance: 100 },
    momentum: 'rising',
    changePercentage: 38,
    signalCount: 15,
    sourceCount: 4,
    ...
    signalsTimeline: TIMELINE(30, 40, 52, 65, 78, 86),
    hiringSignals: [
      { role: 'Labor Law Compliance Manager', volume: 'High', salaryRange: '₹10L - ₹18L p.a.', count: 48 },
    ],
    skillSignals: [
      { skill: 'State-wise Statutory Labor Code Automation (PF/ESI/LWF)', scarcity: 'High', impact: 'Calculates wage deductions across 28 Indian state rulebooks.' },
    ],
    regulatorySignals: [
      { regulationName: 'Indian Code on Wages & Social Security', agency: 'Ministry of Labour and Employment', summary: 'Mandatory electronic wage registers and universal social security coverage.', date: 'May 2026' },
    ],
    technologySignals: [
      { tech: 'Liveness-Verified Edge Facial Recognition on Low-End Android', adoptionRate: 'Maturing', description: 'Prevents photo spoofing on ₹7,000 supervisor smartphones.' },
    ],
    competitionList: [
      { name: 'Paper Muster Rolls', category: 'Manual', strength: 'Strong', pricing: 'Free' },
    ],
    ...
    risks: ['Site supervisor resistance to digital transparency.'],
    ...
    relatedOpportunities: ['saas-ca-firm-workflow', 'bfsi-gst-reconciliation'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '16 Aug 2026',
    source: 'seed',
  },

  // 16. BFSI / Cross-Border
  {
    ...
    vertical: 'BFSI',
    score: 88,
    scores: { demand: 91, hiring: 83, regulation: 89, skills: 85, competition: 66, timing: 94, indiaRelevance: 99 },
    momentum: 'surging',
    changePercentage: 54,
    signalCount: 18,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(22, 34, 48, 62, 76, 90),
    hiringSignals: [
      { role: 'Treasury & FX Risk Manager', volume: 'Medium', salaryRange: '₹25L - ₹40L p.a.', count: 16 },
      { role: 'Cross-Border Payments Compliance Officer', volume: 'High', salaryRange: '₹18L - ₹30L p.a.', count: 24 },
    ],
    skillSignals: [
      { skill: 'FEMA / EDPMS Exim Trade Compliance', scarcity: 'Critical', impact: 'Automates regulatory reporting of inward export remittances.' },
    ],
    regulatorySignals: [
      { regulationName: 'RBI Cross-Border Payment Aggregator (PA-CB) Guidelines', agency: 'RBI', summary: 'Licensing framework for fintech cross-border trade facilitation.', date: 'May 2026' },
    ],
    technologySignals: [
      { tech: 'Multi-Currency Real-Time Ledger Engine', adoptionRate: 'Accelerating', description: 'Handles fractional FX hedging and instant INR disbursement.' },
    ],
    competitionList: [
      { name: 'Traditional SWIFT Wire Transfers', category: 'Legacy Banks', strength: 'Strong', pricing: 'High hidden FX spread (3-5%)' },
    ],
    ...
    risks: ['Strict RBI PA-CB licensing net worth requirements.'],
  ...
  // 17. IT / Privacy (DPDP)
  {
    ...
    vertical: 'IT',
    score: 91,
    scores: { demand: 93, hiring: 87, regulation: 99, skills: 88, competition: 60, timing: 98, indiaRelevance: 100 },
    momentum: 'surging',
    changePercentage: 82,
    signalCount: 26,
    sourceCount: 7,
    ...
    signalsTimeline: TIMELINE(35, 48, 65, 80, 92, 98),
    hiringSignals: [
      { role: 'Data Protection Officer (DPO)', volume: 'High', salaryRange: '₹30L - ₹55L p.a.', count: 42 },
      { role: 'Privacy Engineering Lead', volume: 'High', salaryRange: '₹25L - ₹45L p.a.', count: 30 },
    ],
    skillSignals: [
      { skill: 'DPDP Multi-Lingual Consent Architecture', scarcity: 'Critical', impact: 'Renders legally compliant consent notices in 22 scheduled Indian languages.' },
      { skill: 'Automated PII Discovery & Data Lineage Mapping', scarcity: 'High', impact: 'Finds shadow PII stored in backend analytics logs.' },
    ],
    regulatorySignals: [
      { regulationName: 'Digital Personal Data Protection (DPDP) Act Rules', agency: 'Ministry of Electronics & IT (MeitY)', summary: 'Statutory rules enforcing data principal rights, consent notices, and breach notifications.', date: 'June 2026' },
    ],
    technologySignals: [
      { tech: 'e-Sign and Multi-Lingual Consent Ledger', adoptionRate: 'Accelerating', description: 'Maintains tamper-proof immutable audit logs of user consent lifecycle.' },
    ],
    competitionList: [
      { name: 'Western GDPR CMPs', category: 'Global Privacy SaaS', strength: 'Weak', pricing: 'Expensive, no scheduled Indian language support' },
    ],
    ...
    risks: ['Regulatory timeline extensions by the central government.'],
    indiaRelevanceText: '100% built around MeitY DPDP Act compliance rules and 22 Indian official language mandates.',
    relatedOpportunities: ['bfsi-ai-compliance', 'it-llm-observability'],
    feeds: { reddit: [], github: [], linkedin: [] },
  ...
  // 18. IT / Cloud FinOps
  {
    ...
    vertical: 'IT',
    score: 85,
    scores: { demand: 88, hiring: 82, regulation: 60, skills: 86, competition: 68, timing: 92, indiaRelevance: 84 },
    momentum: 'rising',
    changePercentage: 44,
    signalCount: 16,
    sourceCount: 5,
    ...
    signalsTimeline: TIMELINE(20, 32, 45, 58, 72, 85),
    hiringSignals: [
      { role: 'Cloud FinOps Architect', volume: 'High', salaryRange: '₹22L - ₹38L p.a.', count: 32 },
    ],
    skillSignals: [
      { skill: 'Spot Instance Interruption Handling', scarcity: 'High', impact: 'Gracefully checkpoints state before AWS reclaims GPU nodes.' },
    ],
    regulatorySignals: [],
    technologySignals: [
      { tech: 'Karpenter & Ray Cluster Autoscaling', adoptionRate: 'Maturing', description: 'Provisions optimal instance sizes in real-time based on pending pod queue.' },
    ],
    competitionList: [
      { name: 'Native Cloud Cost Explorer', category: 'Cloud Provider Tool', strength: 'Medium', pricing: 'Free (passive recommendations only)' },
    ],
    ...
    risks: ['Spot instance availability crunches in high-demand GPU regions.'],
  ...
  // 19. HealthTech / Diagnostics
  {
    ...
    vertical: 'HEALTHCARE',
    score: 87,
    scores: { demand: 89, hiring: 78, regulation: 88, skills: 90, competition: 62, timing: 91, indiaRelevance: 98 },
    momentum: 'rising',
    changePercentage: 46,
    signalCount: 15,
    sourceCount: 4,
    ...
    signalsTimeline: TIMELINE(24, 36, 48, 62, 75, 87),
    hiringSignals: [
      { role: 'Medical Imaging Deep Learning Scientist', volume: 'Medium', salaryRange: '₹25L - ₹45L p.a.', count: 18 },
    ],
    skillSignals: [
      { skill: 'DICOM Imaging Pipeline Optimization', scarcity: 'High', impact: 'Compresses and streams full-resolution medical scans over 4G connections.' },
    ],
    regulatorySignals: [
      { regulationName: 'CDSCO Medical Device Rules (Software as Medical Device)', agency: 'Central Drugs Standard Control Organisation', summary: 'Regulatory approval framework for AI diagnostic aids.', date: 'April 2026' },
    ],
    technologySignals: [
      { tech: 'Vision Transformer (ViT) Radiological Models', adoptionRate: 'Accelerating', description: 'Detects subtle lung lesions and micro-fractures with high sensitivity.' },
    ],
    competitionList: [
      { name: 'Manual Teleradiology Outsourcing', category: 'Human Reading Networks', strength: 'Strong', pricing: '₹150-₹300 per scan, 12-24h turnaround' },
    ],
    ...
    risks: ['CDSCO regulatory certification approval lead times.'],
    ...
    relatedOpportunities: ['health-abdm-emr-bridge', 'bfsi-ai-compliance'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '17 Aug 2026',
    source: 'seed',
  },
  ...
  // 20. AgriTech / IoT
  {
    ...
    vertical: 'AGRITECH',
    score: 84,
    scores: { demand: 86, hiring: 74, regulation: 85, skills: 82, competition: 64, timing: 88, indiaRelevance: 99 },
    momentum: 'steady',
    changePercentage: 32,
    signalCount: 13,
    sourceCount: 4,
    ...
    signalsTimeline: TIMELINE(22, 30, 42, 54, 68, 80),
    hiringSignals: [
      { role: 'Embedded IoT Hardware Engineer', volume: 'Medium', salaryRange: '₹12L - ₹20L p.a.', count: 20 },
    ],
    skillSignals: [
      { skill: 'LoRaWAN Long-Range Mesh Networking', scarcity: 'High', impact: 'Maintains sensor telemetry across 50-acre farms without cellular towers.' },
    ],
    regulatorySignals: [
      { regulationName: 'Pradhan Mantri Krishi Sinchayee Yojana (PMKSY)', agency: 'Ministry of Agriculture', summary: 'Up to 55% capital subsidy for micro-irrigation installation.', date: 'May 2026' },
    ],
    technologySignals: [
      { tech: 'Solar-Harvested Sub-GHz LoRa Sensors', adoptionRate: 'Maturing', description: '5-year battery life nodes buried directly in field soil.' },
    ],
    competitionList: [
      { name: 'Imported Israeli Irrigation Systems', category: 'High-End Hardware', strength: 'Strong', pricing: 'Prohibitive (₹3,00,000+ per acre)' },
    ],
    ...
    risks: ['Hardware durability in outdoor monsoon and rodent environments.'],
    ...
    relatedOpportunities: ['agri-fpo-credit-fintech', 'clean-circular-waste-epr'],
    feeds: { reddit: [], github: [], linkedin: [] },
    lastUpdated: '15 Aug 2026',
    source: 'seed',
  },
 ...
 *
 * Expanded high-conviction catalog covering 15+ sectors: BFSI, RegTech, IT,
 * DevOps, AI Infra, HealthTech (ABDM), AgriTech (e-NAM), Logistics/ONDC,
 * LegalTech, Blue-Collar HR, QuickCommerce, and CleanTech.
 */
...
export const seedOpportunities = ${JSON.stringify(RAW_OPPORTUNITIES, null, 2)};
...
fs.writeFileSync(v3Path, fileContent, 'utf-8');
console.log('Successfully wrote', RAW_OPPORTUNITIES.length, 'rich opportunities to', v3Path);

// Sync to base directory if exists
...
if (fs.existsSync(path.dirname(basePath))) {
  fs.writeFileSync(basePath, fileContent, 'utf-8');
