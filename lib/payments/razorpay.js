...
/**
 * Prices are in paise (1 rupee = 100 paise) and decided here, never client-side.
 *
 * Single one-time-purchase plan: ₹199 unlocks every locked report section for
 * good, no recurring charge. periodDays is set to ~100 years so the existing
 * expiresAt plumbing (shared with the old subscription plans) never actually
 * expires a lifetime unlock.
 */
export const PLANS = {
  venture_pro: {
    id: 'venture_pro',
