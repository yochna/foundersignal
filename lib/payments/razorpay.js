...
export const PLANS = {
  starter: { id: 'starter', label: 'Starter Founder Pass', amountPaise: 49_900, currency: 'INR', periodDays: 30 },
  venture_pro: { id: 'venture_pro', label: 'Venture Pro Annual', amountPaise: 499_900, currency: 'INR', periodDays: 365 },
};
