...
export const CLUSTERS = [
  ...
  // --- Batch 3 expansion: Manufacturing, DeepTech, TravelTech + more depth in existing verticals ---
  {
    id: 'manufacturing-msme-erp-copilot',
    name: 'AI ERP Copilot for MSME Manufacturers',
    vertical: 'Manufacturing',
    industry: 'Manufacturing / SME SaaS',
    keywords: {
      'msme manufacturing': 4,
      'shop floor': 3,
  ...
  },
  {
    ...
    name: 'Satellite Crop & Infrastructure Analytics-as-a-Service',
    vertical: 'DeepTech',
    ...
    keywords: {
      ...
      'crop health': 3,
      'yield estimation': 3,
      'crop cutting experiment': 4,
      geospatial: 2,
    },
  },
  {
    id: 'traveltech-pilgrimage-crowd-safety',
    name: 'Pilgrimage & Religious Tourism Crowd-Safety Operations',
    vertical: 'TravelTech',
  ...
  },
  {
    ...
    name: 'D2C RTO & Returns Fraud Prevention Engine',
    vertical: 'ECommerce',
  ...
  },
  {
    ...
    name: 'Parametric Weather-Index Crop Insurance Underwriting',
    vertical: 'BFSI',
    industry: 'BFSI / InsurTech',
    keywords: {
      parametric: 4,
      ...
      'weather index': 4,
      'index insurance': 3,
      'claim payout delay': 3,
    },
  },
  {
    id: 'proptech-rental-tenant-verification',
    name: 'Instant Tenant & Police Verification for Rental Housing',
    vertical: 'PropTech',
    industry: 'PropTech / RegTech',
    keywords: {
      'tenant verification': 5,
      'police verification': 4,
      'rent agreement': 3,
      landlord: 2,
      coliving: 3,
  ...
  },
  {
    ...
    name: 'Agri-Export Phytosanitary & APEDA Compliance for FPOs',
    vertical: 'AgriTech',
    ...
    keywords: {
      ...
      fpo: 3,
      'residue limit': 3,
      'maximum residue limit': 3,
    },
  },
  {
    id: 'saas-vernacular-support-copilot',
    name: 'Vernacular AI Customer-Support Copilot',
    vertical: 'SaaS',
    industry: 'SaaS / Conversational AI',
    keywords: {
      vernacular: 4,
      hinglish: 4,
      'regional language support': 4,
      'code switching': 3,
      'customer support ai': 2,
      'tier 2 tier 3 customers': 3,
    },
  },
  {
    id: 'logistics-driver-safety-telematics',
    name: 'AI Dashcam Driver-Fatigue & Safety Telematics',
    vertical: 'Logistics',
    ...
    keywords: {
      ...
      telematics: 3,
      'fleet safety': 3,
      'commercial vehicle accident': 3,
    },
  },
  {
    id: 'healthtech-nabl-lab-network',
    name: 'NABL Compliance & Quality Network for Diagnostic Labs',
    vertical: 'HealthTech',
