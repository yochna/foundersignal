...
Beyond the summary fields, also produce the deeper analyst package a founder would need to actually decide whether to build this: a TAM/SAM/SOM breakdown sized for India specifically, unit economics with 2-3 realistic pricing tiers, a 3-phase technical build roadmap (each phase ~2 weeks), a buyer persona naming who actually signs the cheque, a go-to-market playbook for the first 10 customers, and a teardown of 1-2 named incumbents explaining exactly why they are vulnerable. Keep monetary figures qualitative ranges rather than invented precision where the signals do not support a specific number.
...
Return exactly this JSON shape:
{
  ...
  "verdictMatrix": { "convictionLevel": "e.g. High Conviction (8/10)", "executionDifficulty": "Low|Moderate|High, with a one-clause reason", "capitalIntensity": "e.g. Low (₹X-₹YL to MVP)", "timeToRevenueMonths": "e.g. 3 - 5 Months", "overallRecommendation": "2-3 sentence blunt verdict" },
  "tamAnalysis": { "tamIndia": "₹ figure or range", "tamGlobal": "$ figure, range, or 'Not directly comparable' if India-specific regulation makes it meaningless", "sam": "₹ figure with one clause on who counts", "som": "₹ figure with a realistic Year 1-2 account count", "cagr": "e.g. 22% YoY", "metricsBreakdown": "the underlying count (registered entities, users, filings) that grounds the TAM" },
  "unitEconomics": { "arpu": "", "cac": "with acquisition channel", "ltv": "", "ltvCacRatio": "", "paybackMonths": "", "grossMargin": "", "targetPricingTiers": [{ "tierName": "", "price": "", "billingCycle": "monthly|annual", "targetSegment": "", "keyFeatures": ["", ""] }] },
  "technicalRoadmap": [{ "phase": "Phase 1: ...", "duration": "Weeks 1-2", "deliverables": ["", ""], "techStack": ["", ""] }],
  "buyerPersona": { "primaryBuyer": "the exact title who signs off", "champions": "who advocates internally", "gatekeepers": "who can block it", "budgetCycle": "how and when budget gets approved", "purchaseTriggers": ["the event that starts a purchase", ""], "mustHaveChecklist": ["a non-negotiable buyer requirement", ""] },
  "gtmPlaybook": { "firstTenCustomersChannel": "the specific channel, not \\"sales and marketing\\"", "coldPitchAngle": "one sentence a founder could actually say", "earlyAdopterIncentive": "", "distributionMoat": "why this gets harder to copy over time" },
  "incumbentTeardown": [{ "name": "real company or category", "weakness": "the specific gap", "whyCannotPivot": "the structural reason they will not fix it", "defensibilityStrategy": "how a newcomer stays ahead once incumbents notice" }]
}`,
      },
    ],
  };
