    ...
    providers.push(
      Credentials({
        ...
        async authorize(credentials) {
          ...
          // Only the configured admin account may sign in directly.
          if (rawLogin === 'mail.jaiswal@gmail.com') {
            return PRESET_ACCOUNTS['mail.jaiswal@gmail.com'];
          }

          // Admin emails configured via ADMIN_EMAILS may also sign in.
          if (isAdminEmail(rawLogin)) {
            return {
