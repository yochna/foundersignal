 ...
 * deeper Logistics / AgriTech / HealthTech coverage), plus the batch-2
 * expansion (PropTech, HRTech, Cybersecurity, LegalTech, Gaming, and more) -
 * 38 opportunities total.
 */
export const fullSeedOpportunities = [...seedOpportunities, ...extraSeedOpportunities, ...extraSeedOpportunities2];
