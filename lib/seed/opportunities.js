...
import { extraSeedOpportunities2 } from './opportunities-extra2.js';
import { extraSeedOpportunities3 } from './opportunities-extra3.js';

/**
 * Full bundled catalog: the base 20 briefs, the 2026 vertical expansion
 * (EdTech, ClimateTech, ECommerce seller tooling, InsurTech, MSME security and
 * deeper Logistics / AgriTech / HealthTech coverage), the batch-2 expansion
 * (PropTech, HRTech, Cybersecurity, LegalTech, Gaming, ClimateTech circular
 * economy), and the batch-3 expansion (Manufacturing, DeepTech, TravelTech,
 * plus further BFSI/PropTech/AgriTech/SaaS/Logistics/HealthTech/ECommerce
 * depth) - 48 opportunities total.
 */
export const fullSeedOpportunities = [
  ...seedOpportunities,
  ...extraSeedOpportunities,
  ...extraSeedOpportunities2,
  ...extraSeedOpportunities3,
];
